...
local function StartFX(proxy, animindex, build)
	...
	inst.AnimState:PlayAnimation("darkness_"..tostring(animindex))
	...
	inst.Light:SetColour(191 / 255, 64 / 255, 191 / 255)
...
local function MakeDarkness(name, build)
	local assets = {
...
return MakeDarkness("darkenessorbs", "warne_lich_fx"),
	MakeDarkness("lichdarkenessorbs", "warne_lich_fx")
