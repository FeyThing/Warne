return {
	...
	ACTIONFAIL =
	{
        ...
        GIVE =
        {
            GENERIC = "Fool! Doesn't belong there.",
        ...
        PICKUP =
        {
			RESTRICTION = "Heh, not going to happen.",
			INUSE = "My patience is running thin.",
        ...
        {
            OUT_OF_WATER = "Pitiful, It's empty.",
        },
        ...
        ROW_FAIL =
        {
            BAD_TIMING0 = "Curses, no one saw that right?",
            BAD_TIMING1 = "Blasted ocean!",
            BAD_TIMING2 = "Whoops, butterfingers!",
        },
		RUMMAGE =
		{
			GENERIC = "Aaargh, not now.",
			INUSE = "Hurry up, you dolt!",
            NOTMASTERCHEF = "I like to imagine my self as versatile. This is not for me.",
            NOTAMERM = "What business do I have touching garbage from fish freaks.",
            NOTSOULJARHANDLER = "Ohoho, fascinating.",
            RESTRICTED = "Can't access it's contents, typical.",
		},
        SADDLE =
        {
            TARGETINCOMBAT = "Careful now, it's not the time to irrationally try that when it's angry!",
        },
		SHAVE =
		{
            ...
            SOMEONEELSESBEEFALO = "Wouldn't it be hilariously if I did go through with it?",
		},
        SING_FAIL =
        {
        ...
        SLAUGHTER =
        {
            TOOFAR = "Blast, lost it.",
        },
        START_CARRAT_RACE =
        {
            NO_RACERS = "Empty, but I can't blame them.",
        },
		STORE =
		{
        ...
        {
            --Recipes/Teacher
            KNOWN = "It's to be expected. Of course I already know it.",
            CANTLEARN = "Egh, what's the point of learning about this?",

            --MapRecorder/MapExplorer
            WRONGWORLD = "If I didn't know any better, I would had assumed I drew this then forgot about it.",

			--MapSpotRevealer/messagebottle
			MESSAGEBOTTLEMANAGER_NOT_FOUND = "What a brilliant idea to follow this map of the surface in a cave.",--Likely trying to read messagebottle treasure map in caves
        ...
        WRAPBUNDLE =
        {
            EMPTY = "Hmmm, time to think of what to wrap.",
        },
        WRITE =
        {
	...
	{
		NO_INGREDIENTS = "Clearly, I'm missing some important components.",
		NO_TECH = "I lack the proper knowledge to continue research!",
		NO_STATION = "Not going to happen without a workstation.",
	},
	...
	ANNOUNCE_PICK_DISEASE_WARNING = "It looks all the same to me.", --removed
	ANNOUNCE_ADVENTUREFAIL = "That didn't go well. I'll have to try again.",
    ANNOUNCE_MOUNT_LOWHEALTH = "It's not like I really care, but I think this creature is about to drop dead.",
	...
	ANNOUNCE_BOOMERANG = "Ack! That wasn't my fault!",
	ANNOUNCE_CHARLIE = "Hello darkness my old friend?",
	ANNOUNCE_CHARLIE_ATTACK = "Ouch, blasted darkness, back off!",
	ANNOUNCE_CHARLIE_MISSED = "only_used_by_winona", --winona specific
	ANNOUNCE_COLD = "Why is this forsaken weather so cold!",
	ANNOUNCE_HOT = "It...logically...should...not...be...this...hot!",
	ANNOUNCE_CRAFTING_FAIL = "I'm missing a couple key ingredients.",
	ANNOUNCE_DEERCLOPS = "Let me guess, an abnormally large monster is within my vacinity.",
	ANNOUNCE_CAVEIN = "Looks like the cave is crushing it, amirite!",
	ANNOUNCE_ANTLION_SINKHOLE =
	{
		"Ooooh wow an earthquake. Such a terrifying predictament! Not!",
		"Hey a tremor! Anyway, moving on.",
		"Sucks to be anyone with feet touching the ground!",
	},
	ANNOUNCE_ANTLION_TRIBUTE =
	{
        "Here, take it you greedy miscreant.",
        "Fine, it's not like I need any of this garbage anyway.",
        "Why am I trying to appease this thing again?",
	},
	ANNOUNCE_SACREDCHEST_YES = "Of course I'm worthy. Why wouldn't I be.",
	ANNOUNCE_SACREDCHEST_NO = "Pfft, it's just a sore loser!",
    ANNOUNCE_DUSK = "What's a little more darkness.",
	...
	ANNOUNCE_EAT =
	{
		...
		PAINFUL = "...",
		SPOILED = "...",
		STALE = "Does it even matter?",
		INVALID = "...",
        YUCKY = "What's the point of putting that in my mouth besides to disgust others.",
    ...
    ANNOUNCE_ATRIUM_DESTABILIZING =
    {
		...
		"Uh huh, yeah no later!",
		"Retreating time.",
	},
    ANNOUNCE_RUINS_RESET = "Oh look, the fodder came back!",
    ANNOUNCE_SNARED = "Wll isn't this ironic!!",
    ANNOUNCE_SNARED_IVY = "I knew it! Why does every plant hate me!",
    ANNOUNCE_REPELLED = "It's shielded!",
	ANNOUNCE_ENTER_DARK = "I welcome the darkness, just not this kind of darkness!",
    ...
    ANNOUNCE_HUNT_START_FORK = "I don't consider myself a fool, but I'll follow with caution.",
    ANNOUNCE_HUNT_SUCCESSFUL_FORK = "Hah, gotcha! It's murdering time.",
    ANNOUNCE_HUNT_WRONG_FORK = "I know I'm a spectacle to behold, but how about you come out and show yourself?",
    ANNOUNCE_HUNT_AVOID_FORK = "Ahhh, a trail fit for even a halfwit.",
	ANNOUNCE_INV_FULL = "I'm clearly not designed to carry all of this!",
	...
	ANNOUNCE_PECKED = "Do I look edible to you, insolent bird!",
	ANNOUNCE_QUAKE = "Heh, a rumbling sound. To ignore it or not is the question.",
	ANNOUNCE_RESEARCH = "Ahahaha, knowledge is power!",
	ANNOUNCE_SHELTER = "One of the few times that nature bothers to help me!",
	ANNOUNCE_THORNS = "Ow!",
	ANNOUNCE_BURNT = "Argh, that burns!",
	ANNOUNCE_TORCH_OUT = "Nonono, this is not the time to burn out!",
	ANNOUNCE_THURIBLE_OUT = "Mmm, depleted.",
	ANNOUNCE_FAN_OUT = "Nothing lasts forever, unless you're me.",
    ANNOUNCE_COMPASS_OUT = "Inconceiveable, did it break?",
	ANNOUNCE_TRAP_WENT_OFF = "Oops.",
	ANNOUNCE_UNIMPLEMENTED = "OW! I don't think it's ready yet.",
	ANNOUNCE_WORMHOLE = "Ack, that was beyond terrible!",
	...
	ANNOUNCE_ACCOMPLISHMENT_DONE = "Excellent!!!",
	ANNOUNCE_INSUFFICIENTFERTILIZER = "Of course the stupid plant is still dissatified.",
	ANNOUNCE_TOOL_SLIP = "Whoops, butterfingers!",
	ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "That was a close call!",
	...
	ANNOUNCE_WET = "Grr, this is not funny!",
	ANNOUNCE_WETTER = "This is humiliating!",
	ANNOUNCE_SOAKED = "Hate, hate, hate...",

	ANNOUNCE_WASHED_ASHORE = "Unbelieveable...",

    ANNOUNCE_DESPAWN = "I can see the light!",
	ANNOUNCE_BECOMEGHOST = "Killlllll!!",
	...
	--winter's feast
	ANNOUNCE_EATING_NOT_FEASTING = "Sharing is for caring. Both of which don't apply to the likes of me.",
	ANNOUNCE_WINTERS_FEAST_BUFF = "I mean it's alright.",
	ANNOUNCE_IS_FEASTING = "Bah humbug!",
	ANNOUNCE_WINTERS_FEAST_BUFF_OVER = "Heh, holidays...",

    --lavaarena event
    ANNOUNCE_REVIVING_CORPSE = "As a favor, if you ever actually die, I'll like to keep your corpse!",
    ANNOUNCE_REVIVED_OTHER_CORPSE = "I'd prefer if you were a raised minion but it is what it is!",
    ANNOUNCE_REVIVED_FROM_CORPSE = "Help is help, so I'll take it.",

    ANNOUNCE_FLARE_SEEN = "A flare? Probably some poor fool dying somewhere.",
    ANNOUNCE_MEGA_FLARE_SEEN = "Well that was not inconspicous at all...",
    ANNOUNCE_OCEAN_SILHOUETTE_INCOMING = "Well look at that, more things to add to my kill list!",
    ...
    ANNOUNCE_ROYALTY =
    {
        "Like I'll bow to the likes of you.",
        "Over my undead body.",
        "Bite me, you royal pain in the...bah whatever.",
    },
    ANNOUNCE_ROYALTY_JOKER =
    {
        "Your \"Up yours\".",
        "Your \"Haha sike\".",
        "My \"Oh I'm sorry do you have a title\"!",
    },

    ANNOUNCE_ATTACH_BUFF_ELECTRICATTACK    = "Mhahaha, power!",
    ANNOUNCE_ATTACH_BUFF_ATTACK            = "Mhahaha, I smite you!",
    ANNOUNCE_ATTACH_BUFF_PLAYERABSORPTION  = "Haha, reinforcements!",
	...
	ANNOUNCE_OCEANFISHING_LINESNAP = "The line snapped. It could be that I'm holding it wrong.",
	ANNOUNCE_OCEANFISHING_LINETOOLOOSE = "Reeling it in with these measly arms of mine. Ha, funny...",
	ANNOUNCE_OCEANFISHING_GOTAWAY = "It got away, because of course it did.",
	ANNOUNCE_OCEANFISHING_BADCAST = "What else is there to expect...",
	ANNOUNCE_OCEANFISHING_IDLE_QUOTE =
	{
		"No fish, I would be afriad of me too.",
		"They probably migrated elsewhere away from me obviously.",
		"Nothing yet, I was never really good at fishing.",
		"I could be researching components for my experiments right now...",
	},
    ...
    {
        "Plants may hate me, but it doesn't mean I don't like learning about them!",
    },

    ANNOUNCE_PLANT_RANDOMSEED = "I'm eager to witness the end result! Just stop dying on me.",

    ANNOUNCE_FERTILIZER_RESEARCHED = "I'm surprised my research yeilded any results for this at all.",

	ANNOUNCE_FIRENETTLE_TOXIN =
	{
		"Ahhh, what else did I expect from a plant!",
		"Why does it burn like fire!",
	},
	ANNOUNCE_FIRENETTLE_TOXIN_DONE = "Note to self: Experiment with Fire Nettle toxin.",

	ANNOUNCE_TALK_TO_PLANTS =
	{
        "Grow you worthless piece of flora!",
        "I will destroy you, if you do not rise from the earth!",
		"You dare mock me cretin! I'll stomp on you if you don't sprout for me!",
        "Any moment, detestable plant...",
        "Arrgh, you're supposed to grow not die!",
	},
    ...
    ANNOUNCE_OFF_SCRIPT = "Bah, only a blockhead cares about following on script.",
    ...
    -- rifts 4
    ANNOUNCE_EXIT_GELBLOB = "We don't speak of this!",
	ANNOUNCE_SHADOWTHRALL_STEALTH = "Bite me again and I'll annihilate you!!",
    ANNOUNCE_RABBITKING_AGGRESSIVE = "Pfft, like I'm afriad of that.",
    ANNOUNCE_RABBITKING_PASSIVE = "Something is softly scuffling underground.",
    ANNOUNCE_RABBITKING_LUCKY = "Research is research, might as well add it to the pile.",
    ANNOUNCE_RABBITKING_LUCKYCAUGHT = "Ha, caught you my little research experiment!",
	...
	BATTLECRY =
	{
		GENERIC = "Sorry not sorry!",
		PIG = "Well, you're not getting any stupider!!",
		PREY = "Die!",
		SPIDER = "Death to you!",
		SPIDER_WARRIOR = "Better you than me!",
		DEER = "It's killing time!",
	},
	COMBAT_QUIT =
	{
		GENERIC = "I sure showed him!",
		PIG = "Run, you blockheaded pig.",
		PREY = "Gah, not worth it!",
		SPIDER = "Yes, back away.",
		SPIDER_WARRIOR = "Running are you? Fine by me.",
	},

	DESCRIBE =
	{
		MULTIPLAYER_PORTAL = "Looks to be an interdimensional portal of some kind.",
        MULTIPLAYER_PORTAL_MOONROCK = "A modified interdimensional portal.",
        MOONROCKIDOL = "A representation of something.",
        CONSTRUCTION_PLANS = "The schematics of what could become reality.",

        ANTLION =
        {
            GENERIC = "What are you looking at, you freeloading oaf?",
            VERYHAPPY = "There, happy? You leeching exploiting mooch!",
            UNHAPPY = "It's angry, not that it's my problem.",
        },
        ANTLIONTRINKET = "Quite worthless. I could toss it to the creature but do I really want to encourage it?",
        ...
        PLAYER =
        {
            ...
            MURDERER = "Think you can take me? Ha, think again!",
            REVIVER = "Took you long enough!",
            GHOST = "Bite me! How about you wait.",
            FIRESTARTER = "It wasn't me! %s did it!",
        },
        WILSON =
        {
        ...
        GLOMMER =
        {
            GENERIC = "I don't know, it's kinda growing on me.",
            SLEEPING = "Hmmm, I wonder if I could use it's remains for materials?",
        },
        GLOMMERFLOWER =
        {
            GENERIC = "Intriguing. It's a shimmering corpse flower.",
            DEAD = "The cycle continues.",
        },
        GLOMMERWINGS = "It could make for some useful research material.",
        GLOMMERFUEL = "What is that? Slime?",
        BELL = "Dingalingaling.",
        STATUEGLOMMER =
        {
		...
		MOLEHILL = "It would be a shame if someone dug up it's little home.",
		MOLEHAT = "I find this hat fairly unsightly, but it's use outweighs its looks.",

		EEL = "Another useless slimy critter.",
		EEL_COOKED = "Still slimy, and still useless.",
		UNAGI = "Another dish that is beneath me.",
		EYETURRET = "I hope it doesn't turn on me.",
		EYETURRET_ITEM = "I suspect it's inactive.",
		MINOTAURHORN = "Fascinating! It could be useful for my research.",
		...
		GIFT = "Is it for me? Strange, I've never recieved a gift before.",
        GIFTWRAP = "That's a wrap!",
		POTTEDFERN = "A fern in a pot.",
        SUCCULENT_POTTED = "A succulent in a pot.",
		SUCCULENT_PLANT = "Aloe there.",
		SUCCULENT_PICKED = "I suppose that are pleasent to look at.",
        ...
        RABBITHOUSE =
        {
            GENERIC = "This decor...I just can't...",
            BURNT = "Crisis adverted, the offending structure has been destroyed!",
        },
        SLURTLE = "Ew. Just ew.",
		...
		ABIGAIL =
		{
            LEVEL1 =
            {
                "I don't get it. It's just another ghost but with a bow.",
                "Is this one special?",
            },
            LEVEL2 =
            {
		...
		AMULET = "Power courses through it.",
		ANIMAL_TRACK = "Tracks left by an animal. A perfect opportunity to kill.",
		ARMORGRASS = "It's a fashion disaster, but I can't be picky.",
		ARMORMARBLE = "I dread wearing this. So heavy.",
		ARMORWOOD = "That is a perfectly reasonable piece of clothing.",
		ARMOR_SANITY = "Fantastic, clearly this is clothing.",
		ASH =
		{
		...
		BABYBEEFALO =
		{
			GENERIC = "Am I supposed to be feeling something now?",
		    SLEEPING = "Good night little one. Whelp time to murder it.",
        },
        BUNDLE = "Our supplies are in there!",
        BUNDLEWRAP = "Wrapping things up should make them easier to carry.",
		BACKPACK = "Perfect! Better than lugging a bunch of needlessly heavy material around.",
		BACONEGGS = "Ah yes, a dead pig, paired with a bird's unborn child.",
		BANDAGE = "It's a piece of paper with honey slathered onto it.",
		BASALT = "That's too strong to break through!", --removed
		BEARDHAIR = "Is, that someone's hair?",
		BEARGER = "Well, it's not going to die any faster.",
		...
		BEEFALO =
		{
            ...
            --Domesticated states:
            DOMESTICATED = "What's the difference? It's just a cow but tamed.",
		...
		BERRIES = "What am I supposed to do with these?",
		BERRIES_COOKED = "It's just a gunky mess now.",
        BERRIES_JUICY = "Do these even have a use for the likes of me?",
        BERRIES_JUICY_COOKED = "This did not help in the slightest.",
		BERRYBUSH =
		{
			BARREN = "I think it needs to be fertilized.",
			WITHERED = "Nothing will grow in this heat.",
			GENERIC = "Do I look like I'm a wilderness expert? Could be toxic.",
			PICKED = "If I know nature, which isn't by a lot. It's probably going to grow back.",
		...
		BIRDCAGE =
		{
			GENERIC = "Right, time to catch and imprison some bird.",
			OCCUPIED = "What? Are you expecting me to pay attention to you?",
			SLEEPING = "The bird is asleep.",
			HUNGRY = "Ahh, it'll be fine I think.",
			STARVING = "Is it straving? I cannot tell.",
			DEAD = "There is a small possibility that I may have neglected it.",
			SKELETON = "It happens.",
		},
		...
		BOARDS = "Boards.",
		BONESHARD = "Useful.",
		BONESTEW = "Well this is quite ominous haha!",
		BUGNET = "For catching bugs.",
		BUSHHAT = "It's kind of scratchy.",
		BUTTER = "What? This makes no sense, and I'm a talking skeleton!",
		BUTTERFLY =
		{
			GENERIC = "It's just a butterfly.",
			HELD = "Now I have you!",
		},
		BUTTERFLYMUFFIN = "What kind of abomination is this!",
		BUTTERFLYWINGS = "Ripping off the wings of a butterfly to relieve stress? Check.",
		...
		CATCOON = "Playful, but carrying resources I need.",
		CATCOONDEN =
		{
			GENERIC = "It's a den in a stump.",
			EMPTY = "Ha, a pity that it died.",
		},
		CATCOONHAT = "Ears hat!",
		...
		CAVE_FERN = "Some fern.",
		CHARCOAL = "Great substitute for firewood.",
		...
		CHESTER_EYEBONE =
		{
			GENERIC = "It's something's eye.",
			WAITING = "It went to sleep.",
		},
		COOKEDMANDRAKE = "I feel nothing.",
		COOKEDMEAT = "Alright, it's cooked. Now what?.",
		COOKEDMONSTERMEAT = "I only cooked it out of boredom.",
		COOKEDSMALLMEAT = "Congrats, it's cooked! Now what?",
		COOKPOT =
		{
			COOKING_LONG = "I just put stuff in it already.",
			COOKING_SHORT = "I can't tell if it's almost done or not.",
			DONE = "Even I can tell it's done.",
			EMPTY = "What use do I have for this if it's not alchemy.",
			BURNT = "Nothing of value was lost.",
		},
		...
		DURIAN = "It supposeably smells, but I wouldn't know. At least watching others disgusted reactions is amusing.",
		...
		DECIDUOUSTREE =
		{
			...
			POISON = "Haha, finders keepers you stupid tree!",
		...
		EVERGREEN =
		{
			...
			BURNT = "I feel like I could have prevented that.",
			CHOPPED = "Take that, nature!",
			GENERIC = "Just a typical evergreen tree. At least I think it is.",
		},
		EVERGREEN_SPARSE =
		{
			BURNING = "What a waste of wood.",
		...
		TWIGGYTREE =
		{
			...
			BURNT = "I feel like I could have prevented that.",
			CHOPPED = "Take that, nature!",
			GENERIC = "Perfect, a whole collection of sticks.",
		...
		FARMPLOT =
		{
			GENERIC = "New hobby, gardening!",
			GROWING = "Grow, or die!",
			NEEDSFERTILIZER = "Hmmmm, needs fertilizer.",
        ...
        COOKBOOK = "Neat! Too bad I have none existant cooking skills.",
		...
		FIRESTAFF = "Mhahahaha, time to set the world on fire!",
		FIRESUPPRESSOR =
		{
			ON = "Fling on!",
		...
		FISH = "It's slimy, and quite useless.",
		FISHINGROD = "I suppose it could stave off boredom.",
		FISHSTICKS = "It's breaded fish. Someone might like it.",
		FISHTACOS = "Am I missing something here? Living creatures like this?",
		FISH_COOKED = "I supposed watching it burn is slightly entertaining.",
		...
		FOOTBALLHAT = "So this is what it's like to be into sports? Meh pathetic but beggars can't be choosers.",
		...
		GHOST = "The undead seem quite common here, strange that most are only ghosts.",
		...
		GOLDNUGGET = "Gold! Usually valueable but useless as currency in the wild.",
		GRASS =
		{
			BARREN = "It's definately not growing without fertilizer.",
			WITHERED = "It's not going to grow back while it's so hot.",
			BURNING = "That's burning fast!",
			GENERIC = "Grass, the pinnacle of nature.",
			PICKED = "Yoink!",
		...
		GUNPOWDER = "Mhahaha, now this is explosive!",
		HAMBAT = "Finally a use for all that meat!",
		HAMMER = "Stop! It's time! To hammer things!",
		HEALINGSALVE = "Only useful to the living.",
		HEATROCK =
		{
		...
		HONEY = "It's sticky and quite frankly very unpleaseent.",
		HONEYCOMB = "Bees used to live in this.",
		HONEYHAM = "Just meat with honey slathered onto it.",
		HONEYNUGGETS = "Just a cluster of fried meat.",
		HORN = "It sounds like a beefalo field in there.",
		HOUND = "Back off mutt!",
		HOUNDCORPSE =
		{
			GENERIC = "A corpse! Well lucky me.",
			BURNING = "It's a shame I had to destroy a perfectly good body.",
		...
		ICEHAT = "I am very much aware of how ridiculous this looks but I don't care.",
		ICEHOUND = "Are there hounds for every season?",
		INSANITYROCK =
		{
			ACTIVE = "Sometimes diving into madness is benefical!",
			INACTIVE = "It's more of a pyramid than an obelisk.",
		},
		JAMMYPRESERVES = "Probably should have made a jar.",

		KABOBS = "It's just meat on a stick.",
		KILLERBEE =
		{
			GENERIC = "Back off you filthy insect!",
			HELD = "Helpless now aren't you?",
		},
		KNIGHT = "Check it out!",
		KOALEFANT_SUMMER = "Die pathetic creature, die!",
		KOALEFANT_WINTER = "I bring death to you, pathetic creature!",
		KOALEFANT_CARCASS = "Adorably dead.",
		KRAMPUS = "Hands off the goods, cretin!",
		KRAMPUS_SACK = "It's mine now, finders keepers.",
		LEIF = "He's huge!",
		...
		LITTLE_WALRUS = "Ugh, it's some small snotnosed brat with a moustache!",
        ...
        MARBLE = "Ahaha, perfect ingredients!",
        MARBLEBEAN = "This just does not make any sense.",
        MARBLEBEAN_SAPLING = "It looks carved.",
        MARBLESHRUB = "It baffles me.",
        MARBLEPILLAR = "I think I could use that.",
        MARBLETREE = "What? What!",
        MARSH_BUSH =
        {
        ...
        MEAT = "Surely it could be utilized for something.",
        ...
        MERM = "Ugh, a dingy looking fishman.",
        MERMHEAD =
        {
            GENERIC = "I point and I laugh.",
            BURNT = "Wow, I'll hate to be any poor fool with a nose.",
        },
        MERMHOUSE =
        {
            GENERIC = "Even I wouldn't live here, and I occupied tombs.",
            BURNT = "They have now been evicted.",
        },
        MINERHAT = "Ahaha, a hands free experience!",
        MONKEY = "Hands off monkey! Touch my stuff and I'll disintegrate you!",
        MONKEYBARREL = "Did that just move?",
        MONSTERLASAGNA = "It's an affront to science.",
        FLOWERSALAD = "A bowl of foliage.",
        ICECREAM = "Ahh, ice cream. Too bad I can't taste it.",
        WATERMELONICLE = "Cryogenic watermelon.",
        TRAILMIX = "A healthy, natural snack.",
        HOTCHILI = "Five alarm!",
        GUACAMOLE = "Avogadro's favorite dish.",
        MONSTERMEAT = "Well I sure don't want it. Maybe the living will appreciate it more.",
        MONSTERMEAT_DRIED = "Strange meat but in jerky form.",
        MOOSE = "No words can describe what I am thinking right now.",
        MOOSE_NESTING_GROUND = "Appears to be some sort of nesting ground.",
        MOOSEEGG = "Where there's an egg, there's an mother.",
        MOSSLING = "And I thought the pigs look dopey. I retract that statement now!",
        ...
        STAFF_TORNADO = "Mwahaha, meet your spinning doom!",
        MOSQUITO =
        {
            GENERIC = "Why are you following me! I have nothing!.",
            HELD = "At least I know that's not my blood, ha!",
        },
        MOSQUITOSACK = "I am unfazed by it's contents.",
        MOUND =
        {
            DUG = "He probably deserved it.",
            GENERIC = "I bet there's all sorts of good stuff down there!",
        },
        NIGHTLIGHT = "I don't understand why no one likes this light. It seems fine to me!",
        NIGHTMAREFUEL = "This stuff is crazy!",
        NIGHTSWORD = "Mhaha, fantastic! The power surges from it's form.",
        ...
        PETALS = "I like them. Too bad they're going to wither away.",
        PETALS_EVIL = "Better appreciate them now before they wither away soon.",
        PHLEGM = "It's thick and pliable. And salty.",
        PICKAXE = "Iconic, isn't it?",
        PIGGYBACK = "This little piggy's gone... \"home\".",
        PIGHEAD =
        {
            GENERIC = "Let me stand here and point and laugh!",
            BURNT = "Crispy.",
        },
        PIGHOUSE =
        {
            FULL = "Look at these dense losers with their fancy shelter. Bah, stupid.",
            GENERIC = "Fancy. Would be ashame if an accident were to happen to them.",
            LIGHTSOUT = "Wow, I know you hate me, but now you're taunting me!",
            BURNT = "Ha, take that you moronic suckers!",
        },
        PIGKING = "Laughable, that's one pitiful king!",
        PIGMAN =
        {
            DEAD = "Good riddance.",
            FOLLOWER = "You are my minion now, and today you will die for me!",
            GENERIC = "Doltish creatures.",
            GUARD = "Serious, but still just as dim.",
            WEREPIG = "Werehog was not on my check list!",
        },
        PIGSKIN = "Neat! It's skin was ripped off.",
        PIGTENT = "Even without a nose, I can tell it's unpleasent in there.",
        PIGTORCH = "Ugh, entitled morons.",
        PINECONE = "It would be quite fun if I threw it at someone.",
        PINECONE_SAPLING = "I'm surprised it's even growing.",
        ...
        PLANT_NORMAL =
        {
            GENERIC = "It's just a random plant.",
            GROWING = "What are you waiting for? Grow!",
            READY = "Time to reap!",
            WITHERED = "Ah such a pity, the heat killed it.",
        },
        ...
        POOP = "Never in my unlife did I imagine myself gathering feces but here I am.",
        ...
        RABBIT =
        {
            GENERIC = "That's just a rabbit.",
            HELD = "Hmmm, I could make use of it.",
        },
        RABBITHOLE =
        {
            GENERIC = "Mmmm, what happens if I demolish it?",
            SPRING = "Blocked off, typical creatures.",
        },
        RAINOMETER =
        {
            GENERIC = "It measures cloudiness.",
            BURNT = "Whelp, you lose some or gain some.",
        },
        RAINCOAT = "Ahaha, pretty neat!",
        RAINHAT = "I think the color brings out my eyes.",
        RATATOUILLE = "Bah, the most generic looking dish ever.",
        RAZOR = "Not much use for me, but the sheer amount of mischeif this tool could cause excites me!",
        ...
        RESEARCHLAB =
        {
            GENERIC = "Bare basic workstation for bare basic solutions.",
            BURNT = "It won't be doing much science now.",
        },
        RESEARCHLAB2 =
        {
            GENERIC = "An upgrade for sure. Ahhh, it's hard being this smart sometimes.",
            BURNT = "The extra science didn't keep it alive.",
        },
        RESEARCHLAB3 =
        {
            GENERIC = "This is where the magic happens!",
            BURNT = "Whatever it was, it's burnt now.",
        },
        RESEARCHLAB4 =
        {
            GENERIC = "Not nearly as brilliant as my spellbook, but it gets the job done.",
            BURNT = "Fire doesn't really solve naming issues...",
        },
        RESURRECTIONSTATUE =
        {
            GENERIC = "Crude, but functional. Pointless for the likes of me.",
            BURNT = "Not much use anymore.",
        },
        RESURRECTIONSTONE = "I may have use for it yet.",
        ROBIN =
        {
            GENERIC = "Does that mean winter is gone?",
            HELD = "It's dying quite fast.",
        },
        ROBIN_WINTER =
        {
            GENERIC = "Life in the frozen wastes.",
            HELD = "It's death looms.",
        },
        ...
        ROCK = "It's a rock. Like I haven't seen a rock before.",
        ...
        ROCK_ICE =
        {
            GENERIC = "Small chunks of ice.",
            MELTED = "Won't be useful until it freezes again.",
        },
        ROCK_ICE_MELTED = "Won't be useful until it freezes again.",
        ICE = "Small chunks of ice.",
        ROCKS = "Quite useful despite how primitive it is.",
        ROOK = "Storm the castle!",
        ROPE = "Some short lengths of rope.",
        ROTTENEGG = "I wonder how my enemies would react if I threw these at them!",
        ROYAL_JELLY = "Now this is just cruel. Of course I can't enjoy it!",
        JELLYBEAN = "Meh.",
        ...
        BRUSH = "If I'm bored enough then sure I'll brush the beast.",
		SANITYROCK =
		{
		...
		SAPLING =
		{
			...
			GENERIC = "I can use it to poke living things.",
			PICKED = "Yoink!",
			DISEASED = "It looks pretty sick.", --removed
			DISEASING = "Err, something's not right.", --removed
		},
        ...
        GARGOYLE_HOUND = "Neat! I think I used to own one of these.",
        GARGOYLE_WEREPIG = "It looks very lifelike.",
		SEEDS = "It's a generic seed. Anything could grow from it.",
		...
		SILK = "Produced by an insect. Quite useful actually.",
		SKELETON = "Oh look! A minion.",
		SCORCHED_SKELETON = "It's a little scorched, but beggars can't be choosers.",
		...
		{
			DEAD = "Death to you!",
			GENERIC = "Quite a nuisance these things are.",
			SLEEPING = "I crave it's death.",
		},
		SPIDERDEN = "Gah, it's sticky!",
		SPIDEREGGSACK = "I could use these to my advantage.",
		SPIDERGLAND = "It has a tangy, antiseptic smell.",
		SPIDERHAT = "Hehehe, you can't have enough minions.",
		SPIDERQUEEN = "Big, but definately killable!",
		SPIDER_WARRIOR =
		{
			DEAD = "Good riddance!",
		...
		SPOILED_FOOD = "Rot, such a familar sight.",
        STAGEHAND =
        {
			AWAKE = "Could you be anymore invasive of my personal space!",
			HIDING = "I'm not falling for it. I can feel the stench of dark magic!",
        },
        STATUE_MARBLE =
        {
		...
		TALLBIRD = "It's mostly all leg, strange.",
		TALLBIRDEGG = "Nice, a spare paperweight.",
		TALLBIRDEGG_COOKED = "It's cooked, so now what?",
		TALLBIRDEGG_CRACKED =
		{
		...
		TENTACLE = "Uh huh, sure I know where this is going.",
		TENTACLESPIKE = "It's pointy and slimy.",
		TENTACLESPOTS = "I could create unthinkable things with these.",
		TENTACLE_PILLAR = "A slimy pole.",
        TENTACLE_PILLAR_HOLE = "Big ominouus hole? Clearly it's a good idea to jump into right?",
		TENTACLE_PILLAR_ARM = "Little slippery arms.",
		TENTACLE_GARDEN = "Yet another slimy pole.",
		TOPHAT = "Oooh, its not halfbad looking.",
		TORCH = "Something to hold back the night.",
		TRANSISTOR = "It's whirring with electricity.",
		TRAP = "I never knew I would create such a thing but here I am.",
		TRAP_TEETH = "This is a nasty surprise.",
		TRAP_TEETH_MAXWELL = "I'll want to avoid stepping on that!", --single player
		TREASURECHEST =
		{
			GENERIC = "Nice, a box to place all of my things in.",
			BURNT = "No, not the chest. My things were in there!",
            UPGRADED_STACKSIZE = "Yes! Give me space.",
		},
		...
		BISHOP_CHARGE_HIT = "Ow! Blasted contraption!",
		TRUNKVEST_SUMMER = "Wilderness casual.",
		TRUNKVEST_WINTER = "Winter survival gear.",
		TRUNK_COOKED = "It's dopey looking, but I think I can make something out of it.",
		TRUNK_SUMMER = "A light breezy trunk.",
		TRUNK_WINTER = "A thick, hairy trunk.",
		TUMBLEWEED = "Ohohoho, Come to Malhz'upher!",
		TURKEYDINNER = "Mmmm.",
		TWIGS = "It's a bunch of small twigs.",
		UMBRELLA = "Yes! Finally some portable shelter from the elements.",
		...
		WATERMELON = "Ugh, it's all over my hands.",
		WATERMELON_COOKED = "It's not any better.",
		WATERMELONHAT = "Sticky, indiscreet, and futile. But I'm having fun.",
		WAXWELLJOURNAL =
		{
			GENERIC = "The glyphs seem to purposely prevent me from reading it.",
			NEEDSFUEL = "only_used_by_waxwell",
		},
		WETGOOP = "Only some desperate idiot would eat that.",
        WHIP = "Nothing like loud noises to help keep the peace.",
		WINTERHAT = "Oooooo, right on my head it goes!",
		WINTEROMETER =
		{
			GENERIC = "Mercurial.",
		...
		TABLE_WINTERS_FEAST =
		{
			GENERIC = "What's the point of inviting me!",
			HAS_FOOD = "Are you mocking me?",
			WRONG_TYPE = "Meh...",
			BURNT = "Haha, hilarious!",
		},
		...
		CRUMBS = "Oh, so you're taunting me now?",
		WINTERSFEASTFUEL = "Yeah whatever.",

        KLAUS = "Hey! If you're santa then you owe me five bucks you nerd!",
        KLAUS_SACK = "Ha, better than five bucks. What a loser.",
		KLAUSSACKKEY = "Well it's mine now. Finders keepers.",
		WORMHOLE =
		{
			GENERIC = "Soft and undulating.",
			OPEN = "Surely I've been through a lot worst.",
		},
		...
		REVIVER = "The beating of this hideous heart will bring somee poor fool to life!",
		...
		LIFEINJECTOR = "A halfbaked attempt at medicine!",
		SKELETON_PLAYER =
		{
        ...
        --Arena Event
        LAVAARENA_BOARLORD = "That's the moronic leader.",
        ...
        {
            ON = "Ha later suckers!",
            GENERIC = "Once again I'm subjected to bloodsports, nothing new.",
        },
        ...
        QUAGMIRE_ALTAR =
        {
        	GENERIC = "Okay so what if I can't cook?",
        	FULL = "I'm surprised it enjoyed that.",
    	},
        ...
        --Wormwood
        COMPOSTWRAP = "Why would I ever need this? I'm a skeleton not a plant!",
        ...
        STEERINGWHEEL = "I admit it. I am not a greeat sailor.",
        ANCHOR = "It would be ludicrous to just leave the boat there without an anchor.",
        BOATPATCH = "Planning ahead.",
        DRIFTWOOD_TREE =
        {
        ...
        ROCK_AVOCADO_FRUIT = "Only an idiot would eat that.",
        ...
        DEAD_SEA_BONES = "Don't mind if I do. More for me!",
        HOTSPRING =
        {
        	GENERIC = "If only I could soak my weary bones.",
        	BOMBED = "Just a simple chemical reaction.",
        	GLASS = "I should not question this at all.",
        ...
        TRAP_STARFISH =
        {
            GENERIC = "Hideous looking creature!",
            CLOSED = "It tried to chomp me!",
        },
        DUG_TRAP_STARFISH = "You're not fooling the likes of me!",
        SPIDER_MOON =
        {
        ...
        MINIFLARE = "Who in their right mind would wish to find me. Oh well maybe I could take their stuff...",
        MEGAFLARE = "Not very conspicuous. But let everything come.",

		MOON_FISSURE =
		{
			GENERIC = "My mind pulses with peace and terror.",
        ...
        MOON_ALTAR_IDOL = "Well I'm sure not carrying it.",
        ...
        {
            GENERIC = "Who came up wwith this design?",
        ...
        MUTATEDHOUND =
        {
        	DEAD = "An end to its miserable life.",
        	GENERIC = "What kind of lab did this thing walk out of?",
        	SLEEPING = "Miserable accursed creature.",
        },

        MUTATED_PENGUIN =
        {
			DEAD = "That's the end of that.",
			GENERIC = "Zombie-like penguin?",
			SLEEPING = "Zombies don't sleep. Definitely cursed or mutated.",
		},
        CARRAT =
        {
        	DEAD = "That's the end of that.",
        	GENERIC = "The pipsqueak looks like someone's experiment gone wrong.",
        	HELD = "I'm tempted to put it out of it's misery.",
        	SLEEPING = "It's a miserable creature even asleep.",
        },

		BULLKELP_PLANT =
        {
            GENERIC = "It's just some kelp.",
            PICKED = "I suppose even useless things may have some later use.",
        },
		...
		COOKIECUTTER = "Hands off the boat you filthy creatures!",
		COOKIECUTTERSHELL = "A shell of its former self.",
		COOKIECUTTERHAT = "I look like a dork wearing this.",
		SALTSTACK =
		{
			GENERIC = "Are those natural formations?",
			MINED_OUT = "Don't mind if I do, all mine!",
			GROWING = "I guess it just grows like that.",
        },
        SALTROCK = "Some creatures find it irresistable. I personally could care less.",
		SALTBOX = "Finally a solution to my spoiling problem!",
        ...
        GNARWAIL =
        {
            GENERIC = "Quite a fascinating horn you have there. It would be ashamed if it disappeared.",
            BROKENHORN = "Well that's quite pathetic.",
            FOLLOWER = "I can't say no to a follower.",
            BROKENHORN_FOLLOWER = "Both loyal and pathetic I see.",
        },
        GNARWAIL_HORN = "Very sharp, heheh!",
		...
		OCEANFISHINGROD = "The normal one was depressing, this does not help.",
		...
		TRIDENT = "I have no clue on how to use a trident. But you never heard it from me.",
        ...
        HERMITHOUSE = {
            GENERIC = "I've seen haunted houses more hospitable than this.",
            BUILTUP = "At least it doesn't look like a hobo squatted inside anymore.",
        },
        ...
        CHUM = "I'd rather look at a zombie horde all day than handle this stuff.",

        SUNKENCHEST =
        {
            GENERIC = "Okay but where's the 'real' treasure?",
            LOCKED = "Grr, it's locked. Unbelieavable!",
        },

        HERMIT_BUNDLE = "She shore shells out a lot of these.",
        HERMIT_BUNDLE_SHELLS = "She DOES sell sea shells!",

        RESKIN_TOOL = "It was to this day too much power was given to Malhz'upher!",
        ...
        -- Webber
        MUTATOR_WARRIOR = "Please stay far away from me as possible!",
        MUTATOR_DROPPER = "Haha, for me? Over my undead body!",
        MUTATOR_HIDER = "Please stay far away from me as possible!",
        MUTATOR_SPITTER = "Haha, for me? Over my undead body!",
        MUTATOR_MOON = "Please stay far away from me as possible!",
        MUTATOR_HEALER = "Haha, for me? Over my undead body!",
        SPIDER_WHISTLE = "I'll pass.",
        ...
        WORTOX_REVIVER = "Hmmm, another resurrection method.",
        WORTOX_SOULJAR = "Fascinating, an extended soul containment method.",
        ...
        MERMHAT = "Clearly these fish morons don't know what they're missing if I have to hide my face behind this of all things.",
        MERMTHRONE =
        {
            GENERIC = "Bah, I despise kings! Fish or not.",
            BURNT = "Serves him right!",
        },
        MOSQUITOMUSK = "Those suckers will never get me!",
        MOSQUITOBOMB = "It's only funny if it's not aimed at me.",
        ...
        MERMHOUSE_CRAFTED =
        {
            GENERIC = "I've seen a lot worst.",
            BURNT = "Sucks to be anyone with a nose!",
        },

        MERMWATCHTOWER_REGULAR = "Bootlickers...",
        MERMWATCHTOWER_NOKING = "A royal guards without a king huh?",
        MERMKING = "Over my undead body would I ever yeild to you!",
        MERMGUARD = "They keep staring at me...",
        MERM_PRINCE = "Princes aren't much better but at least they're easier to manipulate.",

        SQUID = "I have an inkling they'll come in handy.",

		GHOSTFLOWER = "Oddly pretty.",
        SMALLGHOST = "A ghost that happens to be quite small and humanoid? I see where this is going.",

        CRABKING =
        {
            GENERIC = "I can feel a faint hint of corruption enveloping off him.",
            INERT = "It's a little unsightly, but my opinion really does not matter.",
        },
		CRABKING_CLAW = "Not good!",

		MESSAGEBOTTLE = "Strange finding a random bottle out here.",
		MESSAGEBOTTLEEMPTY = "Bah, nothing.",
        ...
        HERMITCRAB = "I can relate to her. I wasn't much of a people person myself.",

        HERMIT_PEARL = "It's delicate.",
        HERMIT_CRACKED_PEARL = "Whoops...my mistake.",

        -- DSEAS
        WATERPLANT = "Seems like they'll only aggro if I removed those barnacles.",
        WATERPLANT_BOMB = "You'll pay for that!",
        ...
        WATERPUMP = "Let's see if fires dare make its presence known around this!",

        BARNACLE = "Pest of the sea.",
        BARNACLE_COOKED = "Never would I have considered them edible.",

        BARNACLEPITA = "Does not look appealing at all.",
        BARNACLESUSHI = "People like this?",
        BARNACLINGUINE = "I don't get it.",
        BARNACLESTUFFEDFISHHEAD = "Eugh.",

        LEAFLOAF = "The living like this?",
        LEAFYMEATBURGER = "A lot of work just to put leaves between two buns.",
        LEAFYMEATSOUFFLE = "What...What...WHAT?",
        MEATYSALAD = "I don't even think I liked salad in life! Eugh.",

        -- GROTTO

		MOLEBAT = "It's literally mostly nose!",
        MOLEBATHILL = "I wonder what might be stuck in that rat's nest.",

        BATNOSE = "Who knows whose nose this is?",
        BATNOSE_COOKED = "I cooked it for no apparent reason.",
        ...
        ARCHIVE_RESONATOR_ITEM = "Aha! Using the combination of both sorcery and science I have created a working device!",
        ...
        ARCHIVE_SWITCH = {
            VALID = "Those gems seem to power it. Looks to utilize magitech of some sort. Maybe the work of an artificer?",
        ...
        TURFCRAFTINGSTATION = "Look even I have standards! Aesthetic is important to me.",
        ...
        COMPOSTINGBIN =
        {
            GENERIC = "It looks foul, but I'm lucky to not possess a sense of smell so I care not.",
            WET = "That looks too soggy.",
            DRY = "Hm... too dry.",
            BALANCED = "Just right!",
            BURNT = "Well that was a bust...",
        },
		...
		PLANTREGISTRYHAT = "Wearing this is a clear sign of a desperate attempt.",

        FARM_SOIL_DEBRIS = "Is it supposed to look like that?",

		FIRENETTLES = "Not if I kill you first!",
		FORGETMELOTS = "Bah, forget about it.",
		SWEETTEA = "I drink and it falls to the ground.",
		TILLWEED = "I shall annihilate you!",
		TILLWEEDSALVE = "My salve-ation.",
        WEED_IVY = "Ack, disgusting weeds!",
        IVY_SNARE = "Hands off you filthy plant!",
        ...
        VEGGIE_OVERSIZED_ROTTEN = "I have a nagging feeling that this is completely my fault.",

		FARM_PLANT =
		{
			GENERIC = "It sure is a plant alright.",
			SEED = "And now, we wait.",
			GROWING = "Grow you stupid plant, grow!",
			FULL = "Success! I really did it!",
			ROTTEN = "Drat! Well that's life, haha!",
			FULL_OVERSIZED = "Wait did I grow this! Haha, I did!",
			ROTTEN_OVERSIZED = "Why am I not surprised.",
			FULL_WEED = "Filthy weed, I found you!",

			BURNING = "That can't be good for the plants...",
		},

        FRUITFLY = "Bite me, pathetic insect!",
        LORDFRUITFLY = "Hey, only one person is allowed to upset the plants, and that person is me!",
        FRIENDLYFRUITFLY = "Finally Exploiting another creature to do all of thhe work does bring benefits!",
        FRUITFLYFRUIT = "Ha! Now I'm in charge!",

        SEEDPOUCH = "I was getting tired of carrying loose seeds in my pockets.",

		-- Crow Carnival
		CARNIVAL_HOST = "Why is he hosting a carnival out here?",
		CARNIVAL_CROWKID = "Bah, it's a child.",
		CARNIVAL_GAMETOKEN = "Carnival currency.",
        ...
        WAGSTAFF_NPC = "What choice do I have? Besides I'm curious.",
        ...
        MONKEY_MEDIUMHAT = "Aha! I've always dreamt of leading a pirate crew!",
        MONKEY_SMALLHAT = "Simple but satisfying.",
        POLLY_ROGERSHAT = "It comes with a bird too?",
        POLLY_ROGERS = "So it's immortal?",
        ...
        CHARLIE_STAGE_POST = "Obviously a set up, but I do enjoy plays.",
        CHARLIE_LECTURN = "Is someone doing a play?",

        CHARLIE_HECKLER = "Pfft, they simply amuse me.",
        ...
        HEDGEHOUND = "Blast! It's an ambush.",
        ...
        STAGEUSHER =
        {
            STANDING = "Just keep your hands off.",
            SITTING = "You don't fool me, I can sense that dark power.",
        },
        SEWING_MANNEQUIN =
        {
		...
		-- Waxwell
		MAGICIAN_CHEST = "I am truly envious of the magic behind this chest.",
		TOPHAT_MAGICIAN = "It's been a while since I've laid eyes on such a stylish hat.",
		...
		HORRORFUEL = "I feel it's dark power coursing through me.",
		DAYWALKER =
		{
			GENERIC = "This is what I get for being even slightly nice! This always happens!",
			IMPRISONED = "It's his fault he got caught. So it's not my problem.",
		},
		DAYWALKER_PILLAR =
		{
			GENERIC = "Is that a rare resource making up these pillars?",
			EXPOSED = "Maybe I could make use of mister big tall, and ugly to acquire the material.",
		},
		DAYWALKER2 =
		{
			GENERIC = "As tempting as it is to taunt this nitwit. I will refrain for now.",
			BURIED = "I'll be back for the body if he suffocates underneath all of that.",
			HOSTILE = "Okay what did I do this time!",
		},
        ...
        PUNCHINGBAG = "Even a nitwit could operate this! Bring it.",
		...
		VOIDCLOTH = "Dark and magically charged fabric? My kind of thing indeed.",
		VOIDCLOTH_KIT = "Shadow weaving! My beloved.",
		VOIDCLOTHHAT = "Aesthetically I like to think of myself as unpurposely 'forboding' but even this is too much.",
		ARMOR_VOIDCLOTH = "And I thought my edge factor was pushing it! This is just ridiculous!",

        VOIDCLOTH_UMBRELLA = "Unfortunately bones aren't immunee to acid, so protection it is.",
        VOIDCLOTH_SCYTHE = "I suppose this weapon visually fits me but I don't know!",

		SHADOWTHRALL_HANDS = "No, no! No touching!",
		SHADOWTHRALL_HORNS = "Back off fool!",
		SHADOWTHRALL_WINGS = "A pathetic display for a spellcaster huh!",
		SHADOWTHRALL_MOUTH = "Keep your filthy mouth to yourself!",

        CHARLIE_NPC = "Wait, is that...?",
        CHARLIE_HAND = "It beckons for an offering.",
        ...
        RECORD_BALATRO = "Oh neat! I do enjoy a game of cards every once and a while.",

        ARCHIVE_ORCHESTRINA_MAIN = "It's like they made it puzzling on purpose.",

        WAGPUNKHAT = "Functionality over stupidity.",
        ARMORWAGPUNK = "I look stupid in this, but oh well.",
        WAGSTAFF_MACHINERY = "One man's trash is another man's treasure.",
        WAGPUNK_BITS = "Who said I'm only interesting in the arcane? Come to papa technology.",
        WAGPUNKBITS_KIT = "A repair kit for machinary. Old man's been busy for sure.",
        ...
        OTTER = "Naturally I don't have any food on me most of the time but they still try!",
        OTTERDEN = {
            GENERIC = "Otter den that, there's not much else there.",
            HAS_LOOT = "It's not stealing if it was stolen from someone else.",
        },
        OTTERDEN_DEAD = "And nothing of value was lost.",
        ...
        OFFERING_POT =
        {
            GENERIC = "Why would I have kelp in the first place?",
            SOME_KELP = "Maybe if I'm feeling generous.",
            LOTS_OF_KELP = "It's comically full. Why am I over here again?",
        },
        ...
        SHADOW_BATTLEAXE = "Mhahaha, niceeeeeee.",
        VOIDCLOTH_BOOMERANG = "Returning projectiles without need of skill? Sign me up!",
		ROPE_BRIDGE_KIT = "This will keep us in suspense!",
		GELBLOB =
		{
			GENERIC = "I'll like a sample!",
			HAS_ITEM = "Curses! You dare steal my possessions!",
			HAS_CHARACTER = "Sucks to be them.",
		},
        RABBITKING_AGGRESSIVE = "I'll gladly put you in your place your 'majesty'!",
        RABBITKING_PASSIVE = "Awww look, it's trying to mimic a corrupt figurehead!",
        ...
        STONE_CHAIR =
        {
            GENERIC = "Finally a chair befitting for my glorious butt!",
            OCCUPIED = "Hey, move it you dolt!",
        },
        ...
        SNOWBALL_ITEM = "Nice. Be right back. I'm going to harrass a few people.",
        ...
        BALATRO_MACHINE = "I do enjoy a game of cards every once and a while.",
    },

    DESCRIBE_GENERIC = "I got nothing. What is it?",
    DESCRIBE_TOODARK = "It's too dark to see!",
    DESCRIBE_SMOLDERING = "That thing is about to catch fire.",

    DESCRIBE_PLANTHAPPY = "Wait, it's happy? It's happy! Take that nature!",
    DESCRIBE_PLANTVERYSTRESSED = "Because of course it's stressed! When is it never stressed!",
    DESCRIBE_PLANTSTRESSED = "Cranky? Well so am I!",
    DESCRIBE_PLANTSTRESSORKILLJOYS = "Weeds...",
    DESCRIBE_PLANTSTRESSORFAMILY = "I cannot determine why it's stressed, but I know for certain that I'm part of the cause.",
    DESCRIBE_PLANTSTRESSOROVERCROWDING = "It's cramped.",
    DESCRIBE_PLANTSTRESSORSEASON = "The blasted weather is ruining it's growth.",
    DESCRIBE_PLANTSTRESSORMOISTURE = "Am I supposed to water it?",
    DESCRIBE_PLANTSTRESSORNUTRIENTS = "It seems to be cravinng something.",
    DESCRIBE_PLANTSTRESSORHAPPINESS = "I have nothing good to say to this forsaken plant.",

    EAT_FOOD =
    {
        TALLBIRDEGG_CRACKED = "Til death do us part.",
		WINTERSFEASTFUEL = "heh.",
    },
